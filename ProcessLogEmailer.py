...
def sendmail():
    ...
    sender_address = 'pnikita5721@gmail.com'
    sender_pass = 'zmoxdtvmwadsyhjw'
    receiver_address = 'shrikantchavan661@gmail.com'
    #Setup the MIME
...
def main():
    ...
    for elem in listprocess: 
        logging.basicConfig(filename="LogFile.text", level=logging.INFO)
        logging.info("\t\t%s"%elem)
